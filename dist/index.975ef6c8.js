...
var _loadMoreBtn = require("./js/load-more-btn");
...
// infinite me button
const infiniteBtn = new (0, _loadMoreBtnDefault.default)({
...
const images = new (0, _fetchimagesDefault.default)();
...
function appendImagesMarkup(imagesObj) {
    refs.gallery.insertAdjacentHTML("beforeend", imagesObj.hits.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>{
        return `
...
function totalHitsChanged(newTotalHits) {
    ...
    if (images.page === 2) (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${totalHits} images`);
    if (images.totalPages === images.page - 1) {
        if (images.page !== 2) (0, _notiflixNotifyAio.Notify).warning("We're sorry, but you've reached the end of search results");
        loadMoreBtn.hide();
        infiniteBtn.hide();
...
function infiniteImages(entries, observer) {
    entries.forEach((entry)=>{
        if (entry.isIntersecting) moreImages();
    });
}

},{"./js/fetchimages":"9SDjO","./js/load-more-btn":"c2vrZ","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9SDjO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ImagesApiService {
    ...
    async fetchImages() {
        const imagesResponse = await (0, _axiosDefault.default)(`${BASE_URL}?key=${KEY}&q=${this.searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=${IMAGESPERPAGE}`);
        if (imagesResponse.status !== 200) throw new Error(imagesResponse.status);
    ...
    calcTotalPages(imagesObj) {
        if (this.page === 1) this.totalPages = Math.ceil(imagesObj.totalHits / IMAGESPERPAGE);
    }
    get query() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c2vrZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class LoadMoreBtn {
...
},{}],"kaxSc":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequireabb0")
